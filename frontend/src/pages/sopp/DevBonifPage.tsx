      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="bg-gray-50 border-b border-gray-200">
            ...
            {'cnt' in (rows[0] ?? {}) && (
              <th className="px-3 py-2 text-right font-semibold text-gray-700">NFs</th>
            )}
          </tr>
        </thead>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          {por_supervisor.length > 0 && (
            <RankTable rows={por_supervisor} nameKey="supervisor" title="Supervisor" />
          )}
        </div>
      </div>
